...
package com.pratik.todoapp.data.source.remote
...
import com.pratik.todoapp.data.source.TasksDataSource
...
object TasksRemoteDataSource : TasksDataSource {
    ...
    init {
        addTask("Task 1", "Task1 description.")
        addTask("Task 2", "Task2 description.")
    }
